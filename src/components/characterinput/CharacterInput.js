...
const raceData = [
  ...
  { race: "gnome", faction: "alliance", availableClasses: ["mage", "rogue", "warlock", "warrior"] },
  {
    race: "human",
    faction: "alliance",
  ...
  { race: "tauren", faction: "horde", availableClasses: ["druid", "hunter", "shaman", "warrior"] },
  {
    race: "troll",
    faction: "horde",
...
const classData = [
  ...
  { type: "mage", race: ["gnome", "human", "troll", "undead"], spec: ["arcane", "fire", "frost"] },
  ...
  { type: "shaman", race: ["orc", "tauren", "troll"], spec: ["ele", "enh", "resto"] },
  { type: "warlock", race: ["gnome", "human", "orc", "undead"], spec: ["aff", "dem", "des"] },
  {
    type: "warrior",
...
const Level = props => (
  <div className="level">
    ...
    <input type="text" value={props.currentLevel}  onChange={e => props.changeLevel("level", e.target.value)} />
  </div>
);
const Faction = props => (
      ...
      props.faction === race.faction ? (
        <div key={index} className="race-icon">
          <img
            ...
            className={
              props.chosenRace !== race.race && props.chosenRace !== "" ? "inactive" : null
            }
          />
        </div>
      ) : null
        ...
        const icon = type.spec.map((spec, index) => (
          <div key={index} className="spec-icon">
            <img
              ...
              className={props.specPicked !== spec && props.specPicked !== "" ? "inactive" : null}
            />
          </div>
        ));
        return icon;
